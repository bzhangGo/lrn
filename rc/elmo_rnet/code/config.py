...
home = os.path.expanduser("path-of/elmo_rnet/")
train_file = os.path.join(home, "data", "train-v1.1.json")
dev_file = os.path.join(home, "data", "dev-v1.1.json")
test_file = os.path.join(home, "data", "dev-v1.1.json")
glove_word_file = os.path.join(home, "data", "glove.840B.300d.txt")

target_dir = "data"
base=os.environ["name"]
log_dir = "%s/event" % base
save_dir = "%s/model" % base
answer_dir = "%s/answer" % base
...
flags.DEFINE_string("elmo_vocab", "path-of/word_vocab.txt",
                    "elmo vocabulary")
flags.DEFINE_string("elmo_options_file",
                    "path-of/data/elmo_2x4096_512_2048cnn_2xhighway_5.5B_options.json",
                    "elmo option file"
                    )
flags.DEFINE_string("elmo_weight_file",
                    "path-of/data/elmo_2x4096_512_2048cnn_2xhighway_5.5B_weights.hdf5",
                    "elmo weight file")

flags.DEFINE_string("cell", "none", "rnn cell type")
...
flags.DEFINE_integer("cycle", 4, "Update cycle")
...
flags.DEFINE_float("elmo_keep_prob", 0.5, "Keep prob in Elmo")
